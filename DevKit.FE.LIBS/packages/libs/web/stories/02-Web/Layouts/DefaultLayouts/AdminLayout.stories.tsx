...
import { AdminPageLayout, IAdminPageLayoutProps } from '../../../../src/layouts/AdminPageLayout/AdminPageLayout';
import { useMockLayoutSettings } from '../../../../src/test-utils/useMockLayoutSettings';

type ComponentType = (args: { locale: 'ar' | 'en' } & IAdminPageLayoutProps) => JSX.Element;
...
const StoryMeta: Meta<ComponentType> = {
	title: 'Web/Layouts/DefaultLayouts/AdminPageLayout',
