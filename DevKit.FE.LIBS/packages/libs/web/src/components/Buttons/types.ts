...
export type SubmitButtonProps = Omit<CommonButtonProps, 'onClick' | 'type'> & (IconVariantProps | TextVariantProps);

export type ResetButtonProps = Omit<CommonButtonProps, 'onClick' | 'type'> & (IconVariantProps | TextVariantProps);
