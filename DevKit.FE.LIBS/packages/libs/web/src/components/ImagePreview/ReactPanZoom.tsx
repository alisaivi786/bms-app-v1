// Copied from https://github.com/mgorabbani/react-image-pan-zoom-rotate/blob/master/src/PanViewer.tsx
...
export default class ReactPanZoom extends React.PureComponent<IReactPanZoomProps> {
	...
	private panWrapper: HTMLDivElement | null | undefined;

	private panContainer: HTMLDivElement | undefined;
